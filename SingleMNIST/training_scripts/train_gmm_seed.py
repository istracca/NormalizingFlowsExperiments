...
os.makedirs('../experiments_seed/models/GMM', exist_ok=True)
os.makedirs('../experiments_seed/logs/GMM', exist_ok=True)
os.makedirs('../experiments_seed/csv/GMM', exist_ok=True)
