...
parser.add_argument('--model', type=str, default='disc_v3', help='Model name')
...
model_dir = '../experiments_seed/models/Disc'
log_dir = '../experiments_seed/logs/Disc'
csv_dir = '../experiments_seed/csv/Disc'
