...
parser.add_argument('--prior', type=str, default='IB', help='Prior type')
...
os.makedirs('../experiments_seed/models/IB', exist_ok=True)
os.makedirs('../experiments_seed/logs/IB', exist_ok=True)
os.makedirs('../experiments_seed/csv/IB', exist_ok=True)
...
logging.basicConfig(
    filename=f'../experiments_seed/logs/IB/IB_{SCALE}_{BETA}_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{SEED}.log',
    filemode='w',
...
csv_path = f'../experiments_seed/csv/IB/IB_{SCALE}_{BETA}_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{SEED}.csv'
...
if not os.path.exists(csv_path):
    with open(csv_path, 'w', newline='') as f:
        ...
        writer.writeheader()
save_dir = f'../experiments_seed/samples/IB/IB_{SCALE}_{BETA}_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{SEED}'
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save({
            ...
            'means': prior.means,
            'epoch': epoch + 1
        }, f'../experiments_seed/models/IB/best_loss_{SCALE}_{BETA}_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{SEED}.pth')
    ...
    if val_acc > best_acc:
        ...
        torch.save({
            ...
            'means': prior.means,
            'epoch': epoch + 1
        }, f'../experiments_seed/models/IB/best_acc_{SCALE}_{BETA}_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{SEED}.pth')
...
torch.save({
    ...
    'optimizer_state_dict': optimizer.state_dict(),
    'means': prior.means
}, f'../experiments_seed/models/IB/final_{SCALE}_{BETA}_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{SEED}.pth')