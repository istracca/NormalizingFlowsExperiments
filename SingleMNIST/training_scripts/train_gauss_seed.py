...
parser.add_argument('--prior', type=str, default='Gaussian', help='Prior type')
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save({
            ...
            'epoch': epoch + 1
        }, f'../experiments_seed/models/Gaussian/best_loss_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{SEED}.pth')
