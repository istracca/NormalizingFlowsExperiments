...
parser.add_argument('--scale', type=float, default=1.0, help='Scale parameter for the GMM prior')
...
MODEL_CONFIG = {
    "MODEL": "hybrid_v3_1x1", 
    "PATH": f"../experiments/models/GMM/best_loss_{SCALE}_hybrid_v3_1x1_GMM_Adam_0.5_0.1.pth",
    "PRIOR": "GMM",
    "DROPOUT": 0.1,
    "TOTAL_DIM": TOTAL_DIM
}
...
if __name__ == "__main__":
    ...
    for seed in SEEDS:
        ...
        prior = prior_class(total_dim=MODEL_CONFIG['TOTAL_DIM'], num_classes=NUM_CLASSES, device=DEVICE, scale=SCALE, fixed_means=True)
