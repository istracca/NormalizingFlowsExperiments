...
os.makedirs(f'../experiments/models/Conditional/{VERSION}', exist_ok=True)
os.makedirs(f'../experiments/logs/Conditional/{VERSION}', exist_ok=True)
os.makedirs(f'../experiments/csv/Conditional/{VERSION}', exist_ok=True)
save_dir = f'../experiments/samples/Conditional/{VERSION}/Conditional_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{COND_DIM}'
...
os.makedirs(os.path.dirname(f'../experiments/logs/Conditional/{VERSION}/Conditional_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{COND_DIM}.log'), exist_ok=True)
logging.basicConfig(
    filename=f'../experiments/logs/Conditional/{VERSION}/Conditional_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{COND_DIM}.log',
    filemode='w',
...
os.makedirs(os.path.dirname(f'../experiments/csv/Conditional/{VERSION}/Conditional_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{COND_DIM}.csv'), exist_ok=True)
csv_path = f'../experiments/csv/Conditional/{VERSION}/Conditional_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{COND_DIM}.csv'
...
for epoch in range(num_epochs):
    ...
    base_save_path = f'../experiments/models/Conditional/{VERSION}/'
    os.makedirs(base_save_path, exist_ok=True)
    suffix = f'{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{COND_DIM}.pth'
...
torch.save({
    ...
    'prior_state_dict': prior.state_dict(),
    'optimizer_state_dict': optimizer.state_dict()
}, f'../experiments/models/Conditional/final_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{COND_DIM}.pth')