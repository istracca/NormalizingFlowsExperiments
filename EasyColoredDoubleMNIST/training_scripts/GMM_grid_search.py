...
def get_pending_experiments():
    ...
    all_combos = list(itertools.product(SCALES, MODELS, PRIORS, OPTIMIZERS, TRANSFORMS, DROPOUT_P, VERSION))
    pending = []
    
    for combo in all_combos:
        scale, model, prior, opt, trans, dropout, version = combo
        path = f"../experiments/logs/GMM/{version}/GMM_{scale}_{model}_{prior}_{opt}_{trans}_{dropout}.log"
