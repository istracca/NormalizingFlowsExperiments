...
os.makedirs(os.path.dirname(f'../experiments/logs/IB/{VERSION}/IB_{SCALE}_{MODEL}_{PRIOR}_{BETA}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{STYLE_VARIANCE}.log'), exist_ok=True)
logging.basicConfig(
    filename=f'../experiments/logs/IB/{VERSION}/IB_{SCALE}_{MODEL}_{PRIOR}_{BETA}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{STYLE_VARIANCE}.log',
    filemode='w',
...
os.makedirs(os.path.dirname(f'../experiments/csv/IB/{VERSION}/IB_{SCALE}_{MODEL}_{PRIOR}_{BETA}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{STYLE_VARIANCE}.csv'), exist_ok=True)
csv_path = f'../experiments/csv/IB/{VERSION}/IB_{SCALE}_{MODEL}_{PRIOR}_{BETA}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{STYLE_VARIANCE}.csv'
...
if not os.path.exists(csv_path):
    with open(csv_path, 'w', newline='') as f:
        ...
        writer.writeheader()
save_dir = f'../experiments/samples/IB/{VERSION}/IB_{SCALE}_{MODEL}_{PRIOR}_{BETA}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{STYLE_VARIANCE}'
...
for epoch in range(num_epochs):
    ...
    os.makedirs(os.path.dirname(f'../experiments/models/IB/{VERSION}/best_loss_{SCALE}_{MODEL}_{PRIOR}_{BETA}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{STYLE_VARIANCE}.pth'), exist_ok=True)
    if val_loss < best_val_loss:
        ...
        torch.save({
            ...
            'means': prior.means,
            'epoch': epoch + 1
        }, f'../experiments/models/IB/{VERSION}/best_loss_{SCALE}_{MODEL}_{PRIOR}_{BETA}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{STYLE_VARIANCE}.pth')
    ...
    if val_acc > best_acc:
        ...
        torch.save({
            ...
            'means': prior.means,
            'epoch': epoch + 1
        }, f'../experiments/models/IB/{VERSION}/best_acc_{SCALE}_{MODEL}_{PRIOR}_{BETA}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{STYLE_VARIANCE}.pth')
...
torch.save({
    ...
    'optimizer_state_dict': optimizer.state_dict(),
    'means': prior.means
}, f'../experiments/models/IB/{VERSION}/final_{SCALE}_{MODEL}_{PRIOR}_{BETA}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{FIXED_MEANS}_{EPOCHS_WARMUP}_{STYLE_VARIANCE}.pth')
