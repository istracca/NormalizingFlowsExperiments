...
os.makedirs(f'../experiments_seed/models/Gaussian/{VERSION}', exist_ok=True)
os.makedirs(f'../experiments_seed/logs/Gaussian/{VERSION}', exist_ok=True)
os.makedirs(f'../experiments_seed/csv/Gaussian/{VERSION}', exist_ok=True)
...
os.makedirs(os.path.dirname(f'../experiments_seed/logs/Gaussian/{VERSION}/Gaussian_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{SEED}.log'), exist_ok=True)
logging.basicConfig(
    filename=f'../experiments_seed/logs/Gaussian/{VERSION}/Gaussian_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{SEED}.log',
    filemode='w',
...
os.makedirs(os.path.dirname(f'../experiments_seed/csv/Gaussian/{VERSION}/Gaussian_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{SEED}.csv'), exist_ok=True)
csv_path = f'../experiments_seed/csv/Gaussian/{VERSION}/Gaussian_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{SEED}.csv'
...
if not os.path.exists(csv_path):
    with open(csv_path, 'w', newline='') as f:
        ...
        writer.writeheader()
save_dir = f'../experiments_seed/samples/Gaussian/{VERSION}/Gaussian_{MODEL}_{PRIOR}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}_{SEED}'
...
for epoch in range(num_epochs):
    ...
    base_save_path = f'../experiments_seed/models/Gaussian/{VERSION}'
