...
model_dir = f'../experiments/models/Disc/{VERSION}'
log_dir = f'../experiments/logs/Disc/{VERSION}'
csv_dir = f'../experiments/csv/Disc/{VERSION}'
...
torch.save({
    'model_state_dict': model.state_dict(),
    'optimizer_state_dict': optimizer.state_dict(),
}, f'{model_dir}/final_{MODEL}_{OPTIMIZER}_{TRANSFORM}_{DROPOUT}.pth')