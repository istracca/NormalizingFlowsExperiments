...
class SimpleFlow(nn.Module):
    def __init__(self, cond_dim, input_dim=4704, hidden_dim=1024, num_layers=8, dropout_p=0.0):
        super().__init__()
...
class GeneralFlow(nn.Module):
    def __init__(self, num_classes=20, cond_dim=64, dropout_p=0.0):
        ...
        for _ in range(8):
            ...
            self.flow1_couplings.append(ChannelCouplingLayer(in_channels=12, cond_dim=cond_dim, hidden_dim=64, dropout_p=dropout_p))
        ...
        for _ in range(8):
            ...
            self.flow2_couplings.append(ChannelCouplingLayer(in_channels=48, cond_dim=cond_dim, hidden_dim=128, dropout_p=dropout_p))
        
        # --- Linear ---
        self.linear_flow = SimpleFlow(cond_dim=cond_dim, input_dim=4704, hidden_dim=2048, num_layers=4, dropout_p=dropout_p)
