...
MODEL_CONFIG = {
    ...
    "PATH": f"../experiments/models/IB/{VERSION}/best_loss_0.0_hybrid_v3_1x1_double_CheckerboardIB_{BETA}_Adam_0.5_0.1_False_20_.pth",
...
RESULTS_CSV = f"csv/IB_{BETA}_{VERSION}/class_cons_IB.csv"
PLOT_DIR = f"plots/IB_{BETA}_{VERSION}/"
...
if __name__ == "__main__":
    ...
    print(f"Configuration: {VERSION} | Total Attributes: {NUM_ATTR} | Beta: {BETA}")
    ...
    for seed in SEEDS:
        ...
        prior = prior_class(total_dim=MODEL_CONFIG['TOTAL_DIM'], arr_num_classes=ARR_NUM_CLASSES, beta=BETA, device=DEVICE, scale=0.0, fixed_means=False)
